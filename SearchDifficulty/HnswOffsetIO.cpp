...
int main(int argc, char *argv[])
{
    ...
    // 输出 JSON / CSV
    std::string out_dir = "/home/zqf/Hulu-Retriever/Results/search_difficulty_results/"+pc.raw_or_basefs+"_results/Offset_results/" + dataset_name + "/" + std::to_string(num_threads)+"_"
