...
sed -i "s|WarmUp/\.\./external|/home/zqf/Hulu-Retriever/external|g" ../compile_commands.json
sed -i "s|WarmUp/\.\./include|/home/zqf/Hulu-Retriever/include|g" ../compile_commands.json
cd ..
